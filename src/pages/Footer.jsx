...
function Footer() {
  return (
    <section >
      ...
      <div className='bg-white text-black w-100 h-15 flex items-center justify-center rounded-3xl text-center font-bold'> Join Our WhatsApp Channel <button className='bg-green-500 rounded-2xl px-3 py-1 ml-5 text-white shadow-xl shadow-green-400/50 animate-bounce'> <a  className='font-semibold' href="https://www.whatsapp.com/channel/0029VbBCJKaGE56c90MpcL2m">Join Now</a></button></div>
